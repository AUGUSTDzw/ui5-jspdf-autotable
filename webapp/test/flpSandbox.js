		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comdzwdocexport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdzwdocexport-display": {
								"semanticObject": "comdzwdocexport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.dzw.docexport",
									"url": sap.ui.require.toUrl("com/dzw/docexport")
								}
							}
						}
					}
